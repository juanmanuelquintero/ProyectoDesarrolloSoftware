...
import './paginaPrincipal-Admin.css'
    ...
    return(
        <div>
            ...
            <div className='contenedor1PaginaPrincipal' style={{position: 'absolute', top: '10%', left: '25%'}}>
                <div className='contenedor2PaginaPrincipal'>
                    ...
                    <div className={inf ? 'contenedorINF-2PaginaPrincipal' : 'contenedorINFPaginaPrincipal'}>
                        <div className={inf ? 'contenedor3PaginaPrincipal' : 'none'}>
                            <label className={inf ? 'label2PaginaPrincipal' : 'none'} style={{position: 'absolute', top: '8%', left: '20%'}}>Administrador {usuario}</label>
                        </div>
                ...
                <button className='botonPaginaPrincipal' style={{position: 'absolute', top: '50%', left: '25%'}}>Empleado</button>
                <button className='botonPaginaPrincipal' style={{position: 'absolute', top: '50%', left: '55%'}}>Cliente</button>
                ...
                <label className='labelPaginaPrincipal' style={{position: 'absolute', top: '75%', left: '72%', fontSize: '50px', color: 'rgb(146, 121, 90)'}}>Pagina principal</label>
            </div>
        </div>
    )
}
